...
// zmqRequest($props,  cmd = "EXPORT_DATA", valueName = "BSC", expectedResponseRoot = "Data_Summary", response = "get");
// "XML_GET_REQUEST_TEMPLATE", "<request COMMAND=\"%s\" valueName=\"%s\"/>"
// <request COMMAND=\"EXPORT_DATA\" valueName=\"BSC\"/>
...
function zmqRequest($props, $cmd, $valueName, $expectedResponseRoot, $requestType, $newValue=NULL)
{
    ...
    $zmqConnect = sprintf("tcp://127.0.0.1:%s", propOrDefault($props, "BSCDataService.data.port", "5560"));
...
function main()
{
    loadBSCProperties($props);

    echo '<?xml version="1.0" encoding="UTF-8"?>';

    $BMCDataServiceEnabled = propOrDefault($props, "BSCDataService.enabled", "1");
